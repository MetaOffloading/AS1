...
public class Q_SES6 {
	public static void Run() {
		...
		SES.item = "In which industry/field do you primarily work?";
		SES.options[0] = "Technology/IT";
		SES.options[1] = "Healthcare";
		SES.options[2] = "Education";
		SES.options[3] = "Finance/Banking";
		SES.options[4] = "Retail";
		SES.options[5] = "Manufacturing";
		SES.options[6] = "Hospitality";
		SES.options[7] = "Agriculture";
		SES.options[8] = "Other";
