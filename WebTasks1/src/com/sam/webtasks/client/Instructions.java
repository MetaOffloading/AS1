...
public class Instructions {
	...
	public static String Get(int index) {
		...
		switch(index) {
		case 0:
            i = "This experiment is in two parts. In the first part you will complete an "
            		+ "online memory game within your web-browser. Then in the second part you "
            		+ "will be asked to fill out a variety of questionnaires.<br><br>"
        ...
        case 8:
            ...
            break;
        case 9:
			i = "You have now completed the memory task. In the remainder of the experiment "
					+ "we would like you to fill out some questionnaires.<br><br>"
	...
	public static String InfoText() {
		String expDur = "30";
		String eligibility = "All registered users of Prolific based in the UK ";
